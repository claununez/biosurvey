...
- *Environmental variables*.- These variables must be in raster format (e.g., GTiff, BIL, ASCII). To load these variables to your R environment, you can use the function `ras` from the package `terra`. 
